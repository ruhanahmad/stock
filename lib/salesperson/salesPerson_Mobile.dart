...
class SalesPersonMobile extends StatefulWidget {
  @override
  _SalesPersonMobileState createState() => _SalesPersonMobileState();
}

class _SalesPersonMobileState extends State<SalesPersonMobile> {
  int _currentIndex = 0;
